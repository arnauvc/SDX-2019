...
leader(Name, Master, Slaves) ->
  receive
    {mcast, Msg} ->
      bcast(Name, {msg, Msg}, Slaves),  %% TODO: COMPLETED
      %% TODO: ADD SOME CODE
      Master ! {deliver, Msg},
      leader(Name, Master, Slaves);
    {join, Peer} ->
      NewSlaves = lists:append(Slaves, [Peer]),
      bcast(Name, {view, self(), NewSlaves}, NewSlaves),  %% TODO: COMPLETED
      leader(Name, Master, NewSlaves);  %% TODO: COMPLETED
    stop ->
      ok;
    Error ->
...
election(Name, Master, Slaves) ->
  ...
  case Slaves of
    [Self|Rest] ->
      ...
      leader(Name, Master, Rest); %% TODO: COMPLETED
    [NewLeader|Rest] ->
      %% TODO: ADD SOME CODE
