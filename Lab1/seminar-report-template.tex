...
\item{Creiem que \´es una pr\`actica molt interessant ja que es pot veure clarament el funcionament dels sistemes distribuits, és molt complicada així entres en les bases de'Erlang. Nosaltres la recomanariem basicament perquè creiem que són les bases bàsiques per treballar amb Erlang i els sistemes distribuits.}
